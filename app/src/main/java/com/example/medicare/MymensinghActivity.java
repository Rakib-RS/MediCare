...
public class MymensinghActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterview, View view, int position, long id) {
                ...
                Intent todetais = new Intent(MymensinghActivity.this, UpdateTablet.class);
    ...
    public void addContact(View v) {
        Intent addNewTablet = new Intent(MymensinghActivity.this, addNewTablet.class);
        startActivity(addNewTablet);
